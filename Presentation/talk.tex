...
\setlength\itemsep{0.6cm}
  ...
  \item Middleware is software occupying a middle position between application programs and operating systems.\lr{I'll properly recreate this picture later.}

\end{itemize}

\begin{center}
\includegraphics[scale=0.7]{fig/Middleware}
\end{center}
...
\setlength\itemsep{0.4cm}
  ...
  \item \textbf{Controlled Interaction} is the interaction between concurrent computations:
