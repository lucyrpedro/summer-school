...
\begin{frame}[fragile]{I/O Bottleneck -- Example -- Titan}
...
\raisebox{0.9cm}{\includegraphics[scale=0.45]{fig/mistral}}
\end{tabular}
\end{center}
...
Burst Buffers deployed: a NERSC
Case Study
Thanks and Acknowledgement to Katie
Antypas, Debbie Bard, Wahid Bhimji, and
Glenn Lockwood of NERSC for much of these
materials
...
\item Middleware can alleviate some of this complexity with solutions \lr{such as ESDM}. % such as ADIOS.
...
- P. Carns et al. Understanding and improving computational science
storage access through continuous characterization. ACM TOS. 2011.
- P. Carns et al. Production I/O characterization on the Cray XE6. CUG
2013. May, 2013.
